...
function drawSwimGraph() {
    ...
    d3.csv("data/swimmingData.csv", function(error, data) {
        ...
        // pull out all 256 swim times for selected gender and distance except those with time = NA
        ...
        swimSVG.append("text")
            ...
            .attr("x", keyCircleMedian + 63)
            .attr("y", keyHeight - 3)
            .text("Hover and click on circles")
            .append('svg:tspan')
            .attr('x', keyCircleMedian + 63)
            .attr('dy', 13)
            .text("in graph for more data");
        ...
        if (selectedGender=="women") {
            imgs.enter()
                .append("svg:image")
                .attr("xlink:href", "assets/swimsuit3f.png")
                .attr("x", "-145")
                .attr("y", "182")
                .attr("width", "100")
                .attr("height", "60");
        ...
        swimSVG.append("text")
            ...
            .text("Between 2003 and 2007, swim times generally")
            .append('svg:tspan')
            .attr('x', width + 50)
            .attr('dy', 20)
            .text("improved at moderate rates.")
            .append('svg:tspan')
            .attr('x', width + 50)
            .attr('dy', 55)
            .text("In 2009, some athletes wore full-body suits made")
            .append('svg:tspan')
            .attr('x', width + 50)
            .attr('dy', 20)
            .text("of polyurethane. Swim times improved dramatically.")
            .append('svg:tspan')
            .attr('x', width + 50)
            .attr('dy', 50)
            ...
            .attr('x', width + 50)
            .attr('dy', 20)
            .text("suits were banned, swim times were slower. Rates")
            .append('svg:tspan')
            .attr('x', width + 50)
            .attr('dy', 20)
            .text("of improvement returned to normal.");
